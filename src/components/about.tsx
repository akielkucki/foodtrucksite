...
const stats = [
  ...
  { value: "5,000+", label: "Trucks Serviced" },
...
const values = [
  {
    title: "Quality First",
    description: "We only stock parts and equipment from trusted manufacturers that meet our rigorous standards.",
    icon: (
  ...
  },
  {
    ...
    description: "Our team brings decades of combined experience in the food truck and mobile kitchen industry.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "We understand that downtime costs you money. That's why we prioritize fast service and support.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
const processSteps = [
  {
    step: "01",
    title: "Consultation",
    description: "Tell us about your truck and what you need. We'll help identify the right parts or services.",
  },
  {
    step: "02",
    title: "Quote",
    description: "Receive a detailed quote with pricing, availability, and timeline for your project.",
  },
  {
    step: "03",
    title: "Fulfillment",
    description: "We source, ship, or install your parts with quality checks at every step.",
  },
  {
    step: "04",
    title: "Support",
    description: "Our team stands behind every sale with ongoing support and warranty service.",
  },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#2F2F2F] sm:text-4xl">
              Serving the Food Truck Industry Since 1999
            </h2>
            <p className="mt-6 text-lg leading-8 text-[#8A8A8A]">
              What started as a small parts shop has grown into one of the most trusted names in the food truck industry. For over 25 years, we've been helping mobile kitchen owners find the parts they need to keep their businesses rolling.
            </p>
            <p className="mt-4 text-[#8A8A8A]">
              Our founder started in the restaurant equipment business and saw a growing need for specialized food truck parts and service. Today, our team combines deep industry knowledge with a genuine passion for helping food entrepreneurs succeed.
            </p>
            <p className="mt-4 text-[#8A8A8A]">
              From our 15,000 sq. ft. facility, we stock thousands of parts and serve customers across the country. Whether you're launching your first truck or managing a fleet, we're here to help.
            </p>
          </div>
        </div>
